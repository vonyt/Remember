...
public class BossEnemyControllerTwo : MonoBehaviour
{
    [SerializeField] int order;
    [SerializeField] AlienBossThree player;
    [SerializeField] public GameObject[] bosses = new GameObject[7];
    [SerializeField] public GameObject[] correctOrder = new GameObject[7];
